	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
            ...
            <?php foreach ($goods as $good):?>
				<tr data-id="<?=$good->id?>">
					<td class="col1"><a href="<?=\yii\helpers\Url::to(["index/goods","id"=>$good->id])?>"><img src="<?=$good->logo?>" alt="" /></a>  <strong><?=\yii\helpers\Html::a($good->name,["index/goods","id"=>$good->id])?></strong></td>
					...
					<td class="col6"><a href="javascrip:;">删除</a></td>
				</tr>
            <?php endforeach;?>
			</tbody>
			<tfoot>
		...
		<div class="cart_btn w990 bc mt10">
			...
			<a href="/orders/index" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->

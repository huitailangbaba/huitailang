		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$good->getall[0]->path."?imageView2/2/w/800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$good->getall[0]->path."?imageView2/2/w/350"?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php foreach ($good->getall as $k=>$img):?>
								<li class="<?= $k>0?"":"cur"?>">
									<a class="<?= $k>0?"":"zoomThumbActive"?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?= $img->path."?imageView2/2/w/350"?>',largeimage: '<?= $img->path."?imageView2/2/w/800"?>'}"><img src="<?= $img->path."?imageView2/2/w/50"?>"></a>
								</li>
                                <?php endforeach;?>

		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="<?=\yii\helpers\Url::to(["index/goods","id"=>$data->id])?>"><img src="<?=$data->logo?>" alt="" /></a></dt>
							<dd><a href="<?=\yii\helpers\Url::to(["index/goods","id"=>$data->id])?>"><?=$data->name?></a></dt>
							<dd><strong>￥<?=$data->shop_price?></strong></dt>
							<dd><a href="javascript:;"><em>已有<?=rand(100000,999999)?>人评价</em></a></dt>
						</dl>
					</li>
                    <?php endforeach;?>
				</ul>
